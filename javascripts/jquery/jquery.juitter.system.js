$(document).ready(function() {
  $.Juitter.start({
    searchType:"fromGustin, fromEntryway", // needed, you can use "searchWord", "fromUser", "toUser"
    searchObject:"entryway, #ew", // needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
